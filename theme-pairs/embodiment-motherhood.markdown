...
<h1>Embodiment and Motherhood in Bloodborne: The Failed Mothers of Yharnam</h1>
...
<details>
  <summary>Arachnophobia warning: Click here for an image of the Rom battle if you don't mind seeing realistic looking spiders. </summary>
  <img src='{{ site.baseurl }}/assets/images/Bloodborne_Rom_Battle.PNG' alt='In the background, a large grey orb-shaped creature with bug-like legs stands behind seven smaller spiders. In the foreground, a figure clothed in black is running over shallow water, a large axe in their hand. The game UI is visible, including a health bar labeled "Rom, the Vacuous Spider"'>
  <figcaption>Rom sends her spider offspring to attack the protagonist.</figcaption>
</details>
<br>
...
<figure>
  <img src='{{ site.baseurl }}/assets/images/Bloodborne_Orphan_Of_Kos.PNG' alt="A grey, wet, skeletal humanoid creature crawls out of a grey organic mass, a tendril snaked around its arm.">
